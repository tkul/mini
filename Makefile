...
M_SRC = main.c signal.c start.c lexer.c dollar.c dollar_utils.c redirections.c remove.c utils.c token.c thisfilewilldeleted.c ft_error.c is_valid.c builtins.c is_builtin.c
