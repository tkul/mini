...
M_SRC = main.c signal.c start.c parser.c dollar.c dollar_utils.c redirections.c remove.c utils.c token.c thisfilewilldeleted.c ft_exec_error.c is_valid.c is_builtin.c free.c built_cd.c built_echo.c built_exit.c built_export.c built_other.c built_unset.c built_export_utils.c executor.c exec_utils.c exec_utils2.c exec_heredoc.c pipe.c exec_dupered.c exec_fclose.c exec_redirection.c exec_path.c exec_close.c exec_red_utils.c exec_single_cmd.c exec_run.c exec_heredoc_utils.c exec_utils3.c exec_utils4.c ft_parser_error.c parser_utils.c token_utils.c sort.c exec_heredoc_writer.c
